...
#### Tabs & Features:
1. **`Export CSV`:**
   - **Share via QR Code:** Generates an offline, high-contrast QR code that encodes the active survey into a compact URL for phone-to-phone camera scanning without cellular service.
