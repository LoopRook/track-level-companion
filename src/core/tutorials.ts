  ...
  steps: [
    {
      ...
      actionHint: 'Review how standard leveling requests an impossible lower through the root, then tap Next Step.',
      requiresAction: false,
      proTip:
  ...
  steps: [
    {
      ...
      actionHint: 'Review Station 50 as our benchmark tie, then tap Next Step.',
      requiresAction: false,
      proTip:
